...
class TariffsControllerTest < ActionController::TestCase
  ...
  test "should create tariff" do
    assert_difference('Tariff.count') do
      post :create, tariff: { name: @tariff.name, ppk: @tariff.ppk, range: @tariff.range, times_of_day: @tariff.times_of_day }
    end
  ...
  test "should update tariff" do
    patch :update, id: @tariff, tariff: { name: @tariff.name, ppk: @tariff.ppk, range: @tariff.range, times_of_day: @tariff.times_of_day }
    assert_redirected_to tariff_path(assigns(:tariff))
  end
